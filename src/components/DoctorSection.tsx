        ...
        >
          <div className="space-y-8">
            ...
            <motion.p 
              ...
              {...fadeInUp}
            >
              Después de meses de automedicación sin éxito, finalmente acudí a un experimentado proctólogo. El doctor estudió cuidadosamente mi situación y me recomendó una solución innovadora: Vitacaps.
            </motion.p>
            ...
            >
              <img 
                ...
                alt="Vitacaps - solución innovadora"
              ...
              <div className="grid grid-cols-3 gap-4">
                <div className="flex flex-col items-center p-6 bg-blue-50 rounded-xl hover:bg-blue-100 transition-colors">
                  ...
                  <span className="text-sm font-medium text-center">Clínicamente probado</span>
                </div>
                <div className="flex flex-col items-center p-6 bg-blue-50 rounded-xl hover:bg-blue-100 transition-colors">
                  <Leaf className="w-10 h-10 text-blue-600 mb-3" />
                  <span className="text-sm font-medium text-center">100% natural</span>
                </div>
                <div className="flex flex-col items-center p-6 bg-blue-50 rounded-xl hover:bg-blue-100 transition-colors">
                  <Award className="w-10 h-10 text-blue-600 mb-3" />
                  <span className="text-sm font-medium text-center">Certificado</span>
                </div>
              </div>
            </motion.div>
          </div>
