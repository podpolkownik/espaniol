      ...
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        >
          ...
          <p className="text-xl text-gray-700 max-w-3xl mx-auto">
            Mujer activa que enfrentó un problema inesperado, 
            pero encontró la fuerza no solo para superarlo, sino también para ayudar a otros
          </p>
        </motion.div>
        ...
        >
          ...
          <div className="space-y-6">
            <h3 className="text-2xl font-bold text-gray-900">El dolor del que no se habla: mi experiencia personal</h3>
            <div className="space-y-8">
              <div>
                <p className="text-lg font-semibold text-gray-800 mb-3">Los primeros signos preocupantes aparecieron de repente:</p>
                <ul className="list-disc pl-6 space-y-2 text-gray-700">
                  <li>Ligera picazón en la zona íntima</li>
                  <li>Incomodidad al caminar</li>
                  <li>Leveña ardor después de ir al baño</li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="list-disc pl-6 space-y-2 text-gray-700">
                  ...
                  <li>Imposibilidad de sentarse con normalidad</li>
                  <li>Deseo constante de rascar la zona con picazón</li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="list-disc pl-6 space-y-2 text-gray-700">
                  ...
                  <li>Tuve que renunciar a mi comida favorita</li>
                  <li>Un miedo constante a salir de casa</li>
                  <li>Me despertaba por la noche debido al dolor intenso</li>
                  <li>Empecé a usar solo ropa suelta</li>
                  <li>Desarrollé depresión por las continuas molestias</li>
                </ul>
              </div>
            </div>
          </div>
