...
export const Hero = () => {
  ...
  const smoothScroll = () => {
    const scrollDistance = window.innerHeight; // Desplazamiento de una pantalla hacia abajo
    ...
    const scrollStep = (timestamp: number) => {
      ...
      // Aumentamos proporcionalmente el desplazamiento
    ...
    <section className="min-h-screen relative flex items-center justify-center overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10 text-center">
        ...
        >
          ...
          <motion.button
            onClick={smoothScroll} // Llamada a la función de desplazamiento al hacer clic
