  ...
  const events = [
    {
      ...
      date: "Hace 6 meses",
      description: "Aparición de las primeras señales de incomodidad",
    ...
    },
    {
      ...
      title: "Recuperación",
      date: "Hoy",
      description: "Vuelta a una vida plena",
      ...
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        >
          ...
          <p className="text-xl text-gray-700 max-w-3xl mx-auto">
            El camino desde los primeros síntomas hasta la recuperación total
          </p>
        </motion.div>
