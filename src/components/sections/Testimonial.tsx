    ...
    <div className="container mx-auto px-4 max-w-4xl">
      ...
      >
        ...
        <blockquote className="text-2xl font-medium text-gray-900 mb-8">
          ...
          volví a una vida plena. No es solo un medicamento, es la oportunidad de volver a sentirme saludable y feliz. Estoy agradecida por cada día sin dolor ni incomodidad."
        </blockquote>
